+++
title = "Sobre"
description = "O que é o xadrez.live e por que este arquivo de lives de xadrez existe."
template = "page.html"
+++

xadrez.live é um arquivo de sessões de xadrez ao vivo: treino, puzzles, partidas rapid, revisão e anotações do que aconteceu em cada live.

O projeto começou com as sessões do fcz, mas o domínio foi pensado para poder crescer como uma vitrine simples para outros streamers de xadrez. A ideia é que cada participante possa ter seu próprio espaço, com páginas de sessão organizadas, links para partidas, vídeos, exercícios e resumos.
